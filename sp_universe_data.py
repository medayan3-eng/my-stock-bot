...
EXTRA_TICKERS_DATA = {
    ...
    # Second batch of requested tickers (2026-07) — only the ones NOT already
    # present in SP500/SP400/SP600 are added here to avoid duplicates.
    "ABVX": ("Abivax SA ADR", "Health Care"),
    "ADPT": ("Adaptive Biotechnologies Corp", "Health Care"),
    "ANET": ("Arista Networks Inc", "Information Technology"),
    "ARQT": ("Arcutis Biotherapeutics Inc", "Health Care"),
    "ASML": ("ASML Holding NV ADR", "Information Technology"),
    "BNS": ("Bank of Nova Scotia", "Financials"),
    "BNY": ("Bank of New York Mellon Corp", "Financials"),
    "BWIN": ("The Baldwin Insurance Group Inc", "Financials"),
    "CARR": ("Carrier Global Corp", "Industrials"),
    "CIFR": ("Cipher Digital Inc", "Information Technology"),
    "CM": ("Canadian Imperial Bank of Commerce", "Financials"),
    "CP": ("Canadian Pacific Kansas City Ltd", "Industrials"),
    ...
    "DFTX": ("Definium Therapeutics Inc", "Health Care"),
    "DNLI": ("Denali Therapeutics Inc", "Health Care"),
    "DYN": ("Dyne Therapeutics Inc", "Health Care"),
    "EMBJ": ("Embraer SA ADR", "Industrials"),
    "FCEL": ("FuelCell Energy Inc", "Industrials"),
    "FTNT": ("Fortinet Inc", "Information Technology"),
    "GGAL": ("Grupo Financiero Galicia SA ADR", "Financials"),
    "GH": ("Guardant Health Inc", "Health Care"),
    "GLUE": ("Monte Rosa Therapeutics Inc", "Health Care"),
    "GPRE": ("Green Plains Inc", "Materials"),
    "HNGE": ("Hinge Health Inc", "Health Care"),
    "HOOD": ("Robinhood Markets Inc", "Financials"),
    "HUT": ("Hut 8 Corp", "Information Technology"),
    "HWM": ("Howmet Aerospace Inc", "Industrials"),
    "IBKR": ("Interactive Brokers Group Inc", "Financials"),
    "ICLR": ("ICON plc", "Health Care"),
    "IMNM": ("Immunome Inc", "Health Care"),
    "INGM": ("Ingram Micro Holding Corp", "Information Technology"),
    "JHX": ("James Hardie Industries plc ADR", "Materials"),
    "LASR": ("nLIGHT Inc", "Information Technology"),
    "LEVI": ("Levi Strauss & Co", "Consumer Discretionary"),
    "LYV": ("Live Nation Entertainment Inc", "Communication Services"),
    "MGA": ("Magna International Inc", "Consumer Discretionary"),
    "MGNI": ("Magnite Inc", "Communication Services"),
    "MLTX": ("MoonLake Immunotherapeutics", "Health Care"),
    "NET": ("Cloudflare Inc", "Information Technology"),
    "NRIX": ("Nurix Therapeutics Inc", "Health Care"),
    "NTRA": ("Natera Inc", "Health Care"),
    "NUVL": ("Nuvalent Inc", "Health Care"),
    "ODFL": ("Old Dominion Freight Line Inc", "Industrials"),
    "OMDA": ("Omada Health Inc", "Health Care"),
    "OSCR": ("Oscar Health Inc", "Health Care"),
    "PCVX": ("Vaxcyte Inc", "Health Care"),
    "PRM": ("Perimeter Solutions SA", "Materials"),
    "RIVN": ("Rivian Automotive Inc", "Consumer Discretionary"),
    "RLAY": ("Relay Therapeutics Inc", "Health Care"),
    "RVLV": ("Revolve Group Inc", "Consumer Discretionary"),
    "RVMD": ("Revolution Medicines Inc", "Health Care"),
    "RVTY": ("Revvity Inc", "Health Care"),
    "SIMO": ("Silicon Motion Technology Corp ADR", "Information Technology"),
    "SNOW": ("Snowflake Inc", "Information Technology"),
    "SYRE": ("Spyre Therapeutics Inc", "Health Care"),
    "TECH": ("Bio-Techne Corp", "Health Care"),
    "TNGX": ("Tango Therapeutics Inc", "Health Care"),
    "TRVI": ("Trevi Therapeutics Inc", "Health Care"),
    "TT": ("Trane Technologies plc", "Industrials"),
    "TVTX": ("Travere Therapeutics Inc", "Health Care"),
    "TWST": ("Twist Bioscience Corp", "Health Care"),
    "TXG": ("10x Genomics Inc", "Health Care"),
    "UBS": ("UBS Group AG ADR", "Financials"),
    "UMAC": ("Unusual Machines Inc", "Industrials"),
    "VIK": ("Viking Holdings Ltd", "Consumer Discretionary"),
    "VOR": ("Vor Biopharma Inc", "Health Care"),
    "VST": ("Vistra Corp", "Utilities"),
    "WSM": ("Williams-Sonoma Inc", "Consumer Discretionary"),
    "XYZ": ("Block Inc", "Financials"),
    "YPF": ("YPF Sociedad Anonima ADR", "Energy"),
    "ZIM": ("ZIM Integrated Shipping Services Ltd", "Industrials"),
}